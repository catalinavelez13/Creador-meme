...
const valor = localStorage.getItem('ligth')
...
//                  BOTON DESCARGA MEME 
// *****************************************************************
/*toBlob: toma el elemento html, lo convierte en una imagen y devuelve un objeto*/
const btnDescarga = document.getElementById('button-descarga')

btnDescarga.addEventListener('click', () =>
domtoimage.toBlob(document.getElementById('caja-meme')).then(blob => saveAs (blob, 'meme.png')))
